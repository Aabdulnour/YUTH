...
export const ROOT_NODE: MindMapNode = {
  ...
  label: "You",
  icon: "🍁",
  description: "Your adult life map. Explore the domains that matter now and decide what to do next.",
  whyItMatters: "Everything connects back to your current situation.",
  parentId: null,
  domain: "root",
  relatedActionIds: [],
  relatedBenefitIds: [],
  ...
  nextStep: "Open the domain that feels most urgent, then take one clear next step.",
};
...
export const DOMAIN_NODES: MindMapNode[] = [
  {
    ...
    nextStep: "Review your cash flow and set one weekly money habit.",
  },
  {
    id: "taxes",
    label: "Taxes",
    ...
    nextStep: "File your return and set up CRA My Account.",
  },
  {
    id: "housing",
    label: "Housing",
    ...
    nextStep: "Check renter supports or first-home options in your province.",
  },
  {
    id: "school",
    label: "School",
    ...
    nextStep: "Review student aid deadlines and your tuition credit paperwork.",
  },
  {
    id: "work",
    label: "Work",
    ...
    nextStep: "Review your pay stub, deductions, and benefits package this week.",
  },
  {
    id: "benefits",
    label: "Benefits",
    ...
    nextStep: "Start with the programs tied to filing and your province.",
  },
  {
    id: "savings",
    label: "Savings",
    ...
    nextStep: "Choose the savings account that fits your next goal.",
  },
  {
    id: "debt",
    label: "Debt",
    ...
    nextStep: "Pick a repayment strategy and check your credit profile.",
  },
  {
    id: "health",
    ...
    nextStep: "Check what your province covers and where you still have gaps.",
  },
  {
    id: "life_moves",
    ...
    nextStep: "Plan the numbers before the life change becomes urgent.",
  },
];
...
export const CHILD_NODES: MindMapNode[] = [
  ...
  },
  {
    ...
    label: "FHSA",
    icon: "🏘️",
    description: "First Home Savings Account with tax-deductible contributions for your first home.",
