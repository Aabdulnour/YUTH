...
export default function HomePage() {
  ...
  return (
    ...
    >
      <div
        className={`fixed inset-x-0 top-0 z-50 transition-transform duration-300 ease-in ease-out ${
          showNav ? "translate-y-0" : "-translate-y-full"
        }`}
      >
        <div className="border-b border-white/8 bg-[#0c0a09]/80 backdrop-blur-xl">
          <div className="mx-auto flex w-full max-w-[1200px] items-center justify-between px-6 py-4 md:px-10">
           <button
              type="button"
              onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
              className="text-sm font-bold tracking-[0.22em] text-white transition hover:opacity-80 cursor-pointer"
            >
              YUTH
            </button>
            ...
            <nav className="flex items-center gap-2">
              <Link
                ...
                className="hidden rounded-lg border border-white/30 px-4 py-2 text-sm font-semibold text-white transition hover:border-white hover:bg-white/10 sm:inline-flex"
              >
                Sign up
              </Link>
              <Link
      ...
      <section className="relative overflow-hidden bg-[#0c0a09]">
        ...
        <div className="relative mx-auto w-full max-w-[1200px] px-6 pb-24 pt-28 md:px-10 md:pt-32 lg:pb-32">
          <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:gap-16">
            ...
            <div className="rounded-2xl border border-[#2e2824] bg-[#141210] p-6 shadow-[0_20px_50px_rgba(0,0,0,0.25)]">
              ...
              <ul className="mt-4 space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-sm text-[#b8b0a8]">
                    <span className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-[#c82233] text-[9px] font-bold text-white">
                      ✓
                    </span>
                    {item}
                  </li>
              ...
              <div className="mt-5 rounded-xl border border-[#3d1a20] bg-[#1e1214] px-4 py-4">
                <p className="text-xs font-semibold uppercase tracking-[0.15em] text-[#9f4a57]">
                  Setup time
                </p>
        ...
        <div className="mx-auto w-full max-w-[1200px] px-6 py-16 md:px-10 md:py-20">
          <div className="grid items-start gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
            <div>
              ...
              <h2 className="mt-4 max-w-[12ch] text-3xl font-bold leading-[1.05] text-[#0f0c0a] md:text-4xl">
                One dashboard for the adult stuff nobody taught you.
              </h2>
              <p className="mt-4 text-base leading-relaxed text-[#5f5953] md:text-lg">
                Government credits, benefit programs, and financial priorities are spread across dozens of
                sites. YUTH reads your profile and surfaces what applies to you.
              </p>
            </div>
            <div className="grid gap-3">
              {CAPABILITIES.map((cap) => (
                <div
                  key={cap.label}
                  className="
                  rounded-2xl border border-[#e6dfd8] bg-white px-6 py-5
                  shadow-[0_4px_18px_rgba(20,15,12,0.035)]
                  transition-all duration-500 ease-[cubic-bezier(.22,1,.36,1)]
                  hover:-translate-y-[2px]
                  hover:border-[#ddd4cc]
                  hover:shadow-[0_10px_26px_rgba(20,15,12,0.06)]
                  "
                >
      ...
      <section className="bg-white" id="how-it-works">
        <div className="mx-auto w-full max-w-[1200px] px-6 py-16 md:px-10 md:py-20">
          <div className="mb-14 text-center">
            ...
            <h2 className="mx-auto mt-4 max-w-[12ch] text-3xl font-bold leading-[1.05] text-[#0f0c0a] md:text-4xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {STEPS.map((step) => (
              <div
                ...
                shadow-[0_4px_18px_rgba(20,15,12,0.03)]
                transition-all duration-500 ease-[cubic-bezier(.22,1,.36,1)]
                hover:-translate-y-[2px]
                hover:shadow-[0_10px_26px_rgba(20,15,12,0.05)]"
              >
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div className="rounded-2xl bg-[#0c0a09] p-8 md:p-10">
              ...
              <p className="mt-6 text-sm leading-relaxed text-[#7a6e68]">
                Federal and provincial programs each have different eligibility rules, deadlines, and portals.
                Without a single view, most people miss what applies to them.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-2 text-base text-[#5f5953]">
                  Programs live across federal, provincial, and municipal systems with no single discovery
                  layer. YUTH is that layer.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-base text-[#5f5953]">
                  A 24-year-old renter in BC filing their first taxes has a completely different priority list
                  than a newcomer in Alberta with dependents. Generic advice misses both.
                </p>
              </div>
              <div className="h-px bg-[#e2dbd4]" />
              <div>
                ...
                <p className="mt-2 text-base text-[#5f5953]">
                  Filing one credit, claiming one benefit, making one better financial decision. These stack.
                  YUTH helps you start.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#0c0a09]">
        <div className="mx-auto w-full max-w-[1200px] px-6 py-14 md:px-10">
          <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#7a6e68]">
                Built on real data
              </p>
              <h2 className="mt-3 text-2xl font-bold text-white md:text-3xl">Grounded. Matched. Transparent.</h2>
            </div>
      ...
      <section className="bg-white">
        <div className="mx-auto w-full max-w-[1200px] px-6 py-20 md:px-10 md:py-24">
          <div className="relative overflow-hidden rounded-[24px] bg-[#c82233] px-10 py-16 text-center md:px-16 md:py-20">
            <div className="pointer-events-none absolute -left-20 -top-20 h-64 w-64 rounded-full bg-white opacity-[0.04] blur-[60px]" />
            <p className="relative text-xs font-semibold uppercase tracking-[0.22em] text-[#f5c0c7]">
              Get started
            </p>
