...
const SECTION_META: { letter: string; label: string }[] = [
  ...
  { letter: "B", label: "Education & Background" },
  { letter: "C", label: "Housing & Life Setup" },
  { letter: "D", label: "Work, Income & Finances" },
];
  ...
  if (isLoading || (isAuthenticated && isInitializing)) {
    return (
      <main className="min-h-screen bg-[#faf8f6] px-6 py-10 text-[#151311]" style={{ fontFamily: "'Inter', 'Avenir Next', 'Segoe UI', sans-serif" }}>
        <div className="mx-auto max-w-3xl rounded-2xl border border-[#e2dbd4] bg-white p-8 text-[#5f5953]">
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl">
        ...
        {/* ── Main card ── */}
        <section className="mt-6 rounded-2xl border border-[#e2dbd4] bg-white p-7 shadow-[0_12px_36px_rgba(20,15,12,0.06)] sm:p-8">
          <h1 className="text-3xl font-bold leading-tight text-[#151311] sm:text-4xl">
            Set up your YUTH profile
          </h1>
          <p className="mt-3 max-w-2xl text-base leading-relaxed text-[#5f5953]">
            Takes about two minutes. Your answers personalize recommendations, action priorities, and AI guidance.
          </p>
          ...
          <div className="mt-8 space-y-6">
            ...
            <section className="rounded-2xl border border-[#e2dbd4] bg-[#faf8f6] p-5 sm:p-6">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h2 className="text-lg font-bold text-[#151311]">Basics</h2>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="block">
                  ...
                  {fieldErrors.age ? (
                    ...
                    <p className="mt-1.5 text-xs text-[#9a7b72]">
                      {ONBOARDING_AGE_MIN}–{ONBOARDING_AGE_MAX}
                    </p>
                  )}
                </label>
              ...
              return (
                <section key={group.id} className="rounded-2xl border border-[#e2dbd4] bg-[#faf8f6] p-5 sm:p-6">
                  <div className="mb-4 flex items-center gap-2.5">
                    ...
                    <h2 className="text-lg font-bold text-[#151311]">{group.title}</h2>
                  </div>
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="mt-0.5 text-xs leading-relaxed text-[#5f5953]">{option.helperText}</p>
                            </div>
                          </div>
                        </button>
                      );
